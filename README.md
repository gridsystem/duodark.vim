...
duodark.vim exposes `duodark#extend_highlight` and `duodark#set_highlight` functions that you can call from within your `~/.vimrc` in order to customize the look of duodark.vim.
